...
void Body::onUpdate()
{
	...
	// ------------------ World Collision ----------------------------------
	glm::vec2 gravity = glm::vec2(0.0f, -980);		// to-do: should be moved to the map
...
{
	return m_halfDimension.x * 2.0f;
}

float Body::getHeight() const
{
	return m_halfDimension.y * 2.0f;
}

float Body::getX() const
{
	return m_position.x - m_halfDimension.x;
}

float Body::getX2() const
{
	return m_position.x + m_halfDimension.x;
}
...
{
	return m_position.y - m_halfDimension.y;
}

float Body::getY2() const
{
	return m_position.y + m_halfDimension.y;
}
...
bool Body::collidesTop() const
{
	return m_collidesTop;
}

bool Body::collidesLeft() const
{
	return m_collidesLeft;
}

bool Body::collidesRight() const
{
	return m_collidesRight;
}
